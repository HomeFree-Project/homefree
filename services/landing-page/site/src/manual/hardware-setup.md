...
| What | Notes |
|---|---|
| **A small computer** for HomeFree | Any mini-PC with **two Ethernet ports** and at least 8 GB of memory. New or refurbished is fine. If a port is missing, a USB-to-Ethernet adapter works. |

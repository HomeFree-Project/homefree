...
class InstallationService:
    ...
    # FLAKE_TEMPLATE and CUSTOM_FLAKES_TEMPLATE moved to the canonical
    # layout module services/instance_layout.py (shared with the admin
    # scaffolder so installer + scaffolder can't drift — see
    # instance_layout.render_flake_nix and test_instance_layout).
...
"""
    ...
    homefree-alt.url = "git+file:///home/nixos/homefree";"""
        ...
        # Generate flake.nix. The template is the canonical managed shape,
        # owned by instance_layout and shared with the admin scaffolder
        # (services/plugins.py) so the two cannot drift — see
        # instance_layout.render_flake_nix and test_instance_layout.
        flake_content = instance_layout.FLAKE_TEMPLATE
        for key, value in variables.items():
        ...
        write_file_privileged(
            ...
            instance_layout.CUSTOM_FLAKES_TEMPLATE,
        )
